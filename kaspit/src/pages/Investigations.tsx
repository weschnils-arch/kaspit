    ...
    <ServicePage
      ...
      intro={
        <>
          ...
          <p>
            Supported by the international network of the KASPIT Group, we transform uncertainty into clarity. From comprehensive background due diligence and asset tracing to complex fraud investigations and litigation support, we provide the strategic intelligence that empowers informed decision-making.
          </p>
        </>
      }
      benefits={[
      ...
      ctaBtn="Request a Private Consultation"
    />
  )
}
